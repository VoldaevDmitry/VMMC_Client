...
namespace Core_Module
{
    public class Files
    {
        ...
        public Files(Core_Module.SessionInfo session)
        {
            sessionInfo = session;

        }

        public ObservableCollection<Core_Module.Files> GetFilesByRevision(Guid revisionId)
        {
            ObservableCollection<Core_Module.Files> files = new ObservableCollection<Core_Module.Files>();
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        Core_Module.Files newFile = new Core_Module.Files(sessionInfo)
                        {
        ...
        public Core_Module.Files GetDbFileByChecksum(string checksum)
        {
            Core_Module.Files dbFile = new Core_Module.Files(sessionInfo);
        ...
        public Core_Module.Files GetDbFileByRevisionFileName(Guid revisionId, string fileName)
        {
            Core_Module.Files dbFile = new Core_Module.Files(sessionInfo);
        ...
        public ObservableCollection<Core_Module.Files> GetDbFiles()
        {
            ObservableCollection<Core_Module.Files> files = new ObservableCollection<Core_Module.Files>();
            files.Clear();
        ...
        public string CreateDbFile(bool ignoreChecksum) //new version using Stored Procedure
        {
            ...
            try
            {
                Core_Module.Files existFile = GetDbFileByRevisionFileName(RevisionId, FileName);
        ...
        public ObservableCollection<Core_Module.Files> GetFilesByRevision_filestream(Guid revisionId)
        {
            ObservableCollection<Core_Module.Files> files = new ObservableCollection<Core_Module.Files>();
        ...
        public Core_Module.Files GetDbFile_filestream(string checksum)
        {
            Core_Module.Files dbFile = new Core_Module.Files(sessionInfo);
        ...
        public ObservableCollection<Core_Module.Files> GetDbFiles_filestream()
        {
            ObservableCollection<Core_Module.Files> files = new ObservableCollection<Core_Module.Files>();
            files.Clear();
        ...
        public string CreateDbFile_filestream()
        {
            ...
            try
            {
                Core_Module.Files existFile = GetDbFileByChecksum(Checksum);
                if (existFile == null)
                {
